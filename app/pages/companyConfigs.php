  ...
  .done(function( data ) {
      ...
      switch (jsonResponse.result) {
        ...
        case 'ERROR_EMAIL_NOT_SENT':
            $(document.body).append(window.notifications.show())
        break;
        case 'SUCCESS':
            $("#NewUser").modal('hide');
...
$('a[aria-controls="profiles"]').on('shown.bs.tab', function (e) {
  ...
  .done(function( data ) {
   ...
   $("#table-body-Users-Profiles").append('<tr><td>'+obj[i].name+'</td><td></td></tr>');
   console.log(obj[i]);
  }
...
<div class="row" style="margin-top:15px;">
  ...
  <div class="btn-group" role="group" aria-label="...">
      <button type="button" class="btn btn-primary btn-outline  " data-toggle="modal" data-target="#NewProfile">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
         ...
         <table style="text-align: center;"class="table  table-hover table-bordered">
          <tr><td><input type="text"placeholder="Nome do Perfil"></td><td>Nada</td><td>Visualizar</td><td>Visualizar/Criar/Alterar</td><td>Visualizar/Criar/Alterar/remover</td></tr>
